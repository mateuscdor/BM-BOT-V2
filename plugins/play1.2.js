...
if (command == 'play.1') {
let espera = '*❮❗❯ Por favor aguarde un momento en lo que descargo y envío su audio, gracias*'
m.reply(espera)
let res = await fetch("https://api.dhamzxploit.my.id/api/ytplaymp3?text="+text)
let json = await res.json()
conn.sendFile(m.chat, json.result.url, 'error.mp3', null, m, false, { mimetype: 'audio/mp4' })}
if (command == 'play.2') {
let espera = '*❮❗❯ Por favor aguarde un momento en lo que descargo y envío su vídeo, gracias*'
m.reply(espera)
